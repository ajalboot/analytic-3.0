...
def classify():
    ...
    print('Platform(B):-------------------------------------')
    print('Platform(B): User Classification Start Time :', (classificationStart_time))
    print('Platform(B): User Classification End Time   :', (classificationEnd_time))
    print('Platform(B): Total Classification time      :', (classificationEnd_time - classificationStart_time))
    print('Platform(B):-------------------------------------')
